    ...
    roles: [
        {
            ...
            role: {
                id: "be2c9a26-3040-4a15-8cea-139d71d4f328",
                organizationId:
                    "99fd17c1-bdf4-4d50-88f4-b89d97afe905",

                name: "Organization Super Admin",

                description:
                    "Full system access and global configuration",
...
/* ============================================================
   DUMMY DASHBOARD RESPONSE
============================================================ */

const dummyDashboard: DashboardResponse = {
    success: true,
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <View
                        style={
                            styles.licenseTextContainer
                        }
                    >
                        <View
                            style={
                                styles.licenseTitleRow
                            }
                        >
                            <Text
                                style={
                        ...
                        <Text
                            style={
                                styles.licenseConsumed
                            }
                        >
                            {
                                licenseQuota.consumed
                            }{" "}
                            of{" "}
                            {
                                licenseQuota.max
...
const OrderSummary = ({
    ...
    const draft =
        orders?.DRAFT?.count ?? 0;

    const completed =
        orders?.COMPLETED?.count ?? 0;
...
export default function SuperAdminDashboard() {
    /*
     * In your real application this will eventually come from:
     *
    ...
    const organizationName =
        user.organization?.name ||
        typedDashboard.organizationInfo
            ?.name ||
        typedDashboard
    ...
    const cards =
        typedDashboard.cards || {};

    const orders =
        typedDashboard.orders || {};
        ...
        >
            ...
            >
                ...
                <SectionCard
                    ...
                    subtitle="Key enterprise metrics"
                >
                    <View
                        style={
                            styles.kpiGrid
                ...
                {typedDashboard
                    ...
                    0 && (
                        ...
                        >
                            ...
                            >
                                {typedDashboard.recentUsers.map(
                                    (
                                        recentUser
                                    ) => (
                                        <View
